...
mail.settings.sender = 'agiovani@estech.com.br'
mail.settings.login = 'agiovani@estech.com.br:es_5629835'


#mail = Mail()
#mail.settings.server = 'smtp.gmail.com:587'
#mail.settings.sender = 'amauri.giovani@gmail.com'
#mail.settings.login = 'amauri.giovani:******'
